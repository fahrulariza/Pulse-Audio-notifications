...
# ==============================================================================
# Skrip: audio-adzan-04.sh
# Versi: 6.00
# Deskripsi: Mengatur pemutaran Al-Qur'an sebelum adzan Isya, adzan itu sendiri,
...
log_message "INFO" "Memulai audio-adzan-04.sh (Isya) Versi 6.00"

# Durasi pemutaran Qur'an sebelum adzan Isya (10 menit)
QURAN_PLAYBACK_DURATION_PRE_ADZAN=600 # 10 menit

log_message "INFO" "Memulai pemutaran Al-Qur'an dari halaman terakhir selama ${QURAN_PLAYBACK_DURATION_PRE_ADZAN} detik sebelum adzan Isya."
...
log_message "INFO" "Memutar adzan Isya: ${AUDIO_ADZAN_DEFAULT}"
...
if [ "$DAY_OF_WEEK" = "Thu" ] || [ "$DAY_OF_WEEK" = "Fri" ]; then
    ...
    log_message "INFO" "Memutar Al-Qur'an selama 30 menit setelah Iqamah (khusus Kamis/Jumat Isya)."
    play_quran_timed 1800 "start" # 30 menit = 1800 detik
fi

log_message "INFO" "Proses skrip audio-adzan-04.sh selesai."
