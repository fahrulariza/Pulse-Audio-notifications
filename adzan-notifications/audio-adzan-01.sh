...
# ==============================================================================
# Skrip: audio-adzan-01.sh
# Versi: 6.00
# Deskripsi: Mengatur pemutaran Al-Qur'an sebelum adzan Subuh, adzan itu sendiri,
#            audio setelah adzan, jeda dengan Al-Qur'an sebelum iqamah, iqamah,
#            dan pemutaran Al-Qur'an lanjutan setelah iqamah.
...
log_message "INFO" "Memulai audio-adzan-01.sh (Subuh) Versi 6.00"

# Durasi pemutaran Qur'an sebelum adzan Subuh (10 menit)
QURAN_PLAYBACK_DURATION_PRE_ADZAN=600 # 10 menit

log_message "INFO" "Memulai pemutaran Al-Qur'an dari halaman terakhir selama ${QURAN_PLAYBACK_DURATION_PRE_ADZAN} detik sebelum adzan Subuh."
...
log_message "INFO" "Memutar adzan Subuh: ${AUDIO_ADZAN_FAJR}"
sudo -u pulse /usr/bin/paplay --volume="$VOLUME_ADZAN" "$AUDIO_ADZAN_FAJR"
...
# Logika tambahan Subuh: jeda 10 menit lalu memutar Al-Qur'an selama 60 menit
log_message "INFO" "Jeda 10 menit setelah Iqamah (khusus Subuh)."
sleep 600 # 10 menit = 600 detik

log_message "INFO" "Memutar Al-Qur'an selama 60 menit setelah Iqamah (khusus Subuh)."
play_quran_timed 3600 "start" # 60 menit = 3600 detik

log_message "INFO" "Proses skrip audio-adzan-01.sh selesai."
